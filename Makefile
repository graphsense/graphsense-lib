...
VENV := venv
RELEASESEM := 'v2.13.0+pysparkingest.26'
WEBAPISEM := 'v2.13.0'
...
mcp-validate-curation:
	uv run --exact --extra mcp graphsense-cli mcp validate-curation
