...
Usage:
    ...
    uv run pytest tests/web/test_baseline_regression.py -v -m regression

    # With specific baseline version
    BASELINE_VERSION=v25.11.16 uv run pytest tests/web/test_baseline_regression.py -v

    # Skip baseline container for quick iteration
    SKIP_BASELINE_CONTAINER=1 uv run pytest tests/web/test_baseline_regression.py -v
"""
...
# Server endpoints
CURRENT_SERVER = os.environ.get("NEW_SERVER", "http://localhost:9000")
