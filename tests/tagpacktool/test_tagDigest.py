...
def tagsCryptoDogs():
    return loadtestFile(
        "tests/tagpacktool/testfiles/TagPublic/0xdeadbeefdeadbeefdeadbeefdeadbeef_tags.json"
    )
...
def tagsIA():
    return loadtestFile(
        "tests/tagpacktool/testfiles/TagPublic/1Archive1n2C579dMsAu3iC6tWzuQJz8dN_tags.json"
    )


@pytest.fixture
def tagsExchange():
    return loadtestFile("tests/tagpacktool/testfiles/TagPublic/exchange_tags.json")
