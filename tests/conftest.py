...
# Distraction keyspaces for tests/db/test_keyspace_discovery.py.
# Mirror any changes in tests/web/cassandra/init-schemas.py (baked image).
#
# Per-entry fields:
...
#   has_configuration:(raw) populate the configuration table (back-compat probe)
DISCOVERY_KEYSPACES = [
    # === Transformed: marker + no_blocks selection on the disctest network ===
    {
        "name": "disctest_btc_transformed_20260101",
        "kind": "transformed",
        "no_blocks": 100,
        "has_state": True,
        "bootstrapped": True,
    ...
    {
        "name": "discbc_btc_transformed_20260301",
        "kind": "transformed",
        "no_blocks": 700,
        "has_state": False,
        "bootstrapped": False,
