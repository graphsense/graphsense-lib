...
class GraphAddressSummary(BaseModel):
    """
    GraphAddressSummary
    """ # noqa: E501
    overall: GraphAddressOverall
    networks: List[GraphAddressNetworkSummary]
    __properties: ClassVar[List[str]] = ["overall", "networks"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "overall": GraphAddressOverall.from_dict(obj["overall"]) if obj.get("overall") is not None else None,
            "networks": [GraphAddressNetworkSummary.from_dict(_item) for _item in obj["networks"]] if obj.get("networks") is not None else None
        })
        return _obj
