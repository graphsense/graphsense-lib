...
class GraphTxSummary(BaseModel):
    """
    GraphTxSummary
    """ # noqa: E501
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "overall": GraphTxOverall.from_dict(obj["overall"]) if obj.get("overall") is not None else None,
            "networks": [GraphTxNetworkSummary.from_dict(_item) for _item in obj["networks"]] if obj.get("networks") is not None else None
        })
        return _obj
