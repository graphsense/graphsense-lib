...
class SearchResultLevel1(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {
                "neighbor": NeighborEntity.from_dict(obj["neighbor"])
                if obj.get("neighbor") is not None
                else None,
                "matching_addresses": [
                    Address.from_dict(_item) for _item in obj["matching_addresses"]
                ]
                if obj.get("matching_addresses") is not None
                else None,
                "paths": [SearchResultLevel2.from_dict(_item) for _item in obj["paths"]]
