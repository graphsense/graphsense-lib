        ...
        _obj = cls.model_validate(
            {
                ...
                "uri": obj.get("uri"),
                "categories": [
                    LabeledItemRef.from_dict(_item) for _item in obj["categories"]
                ]
                if obj.get("categories") is not None
                else None,
                "jurisdictions": [
                    LabeledItemRef.from_dict(_item) for _item in obj["jurisdictions"]
                ]
                if obj.get("jurisdictions") is not None
                else None,
                "nr_tags": obj.get("nr_tags"),
                "context": ActorContext.from_dict(obj["context"])
