...
class GraphSummary(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "txs": GraphTxSummary.from_dict(obj["txs"]) if obj.get("txs") is not None else None,
            "addresses": GraphAddressSummary.from_dict(obj["addresses"]) if obj.get("addresses") is not None else None
        })
        return _obj
