        ...
        _obj = cls.model_validate(
            {
                ...
                "input_value": Values.from_dict(obj["input_value"])
                if obj.get("input_value") is not None
                else None,
                "output_value": Values.from_dict(obj["output_value"])
                if obj.get("output_value") is not None
                else None,
            }
        )
        return _obj
