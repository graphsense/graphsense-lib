...
# Synced from src/graphsenselib/convert/address_scan/detectors.py via
...
from graphsense.address_scan.validators import validate_address, validate_xrp_address
