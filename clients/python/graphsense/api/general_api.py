...
class GeneralApi:
    ...
    def search(
        ...
        currency: Annotated[
            Optional[StrictStr], Field(description="The cryptocurrency (e.g., btc)")
        ] = None,
        limit: Annotated[
            Optional[StrictInt], Field(description="Maximum number of search results")
        ] = None,
        include_sub_tx_identifiers: Annotated[
            Optional[StrictBool],
            Field(description="Whether to include sub-transaction identifiers"),
        ] = None,
        include_labels: Annotated[
            Optional[StrictBool], Field(description="Whether to include labels")
        ] = None,
        include_actors: Annotated[
            Optional[StrictBool], Field(description="Whether to include actors")
        ] = None,
        include_txs: Annotated[
            Optional[StrictBool], Field(description="Whether to include transactions")
        ] = None,
        include_addresses: Annotated[
            Optional[StrictBool], Field(description="Whether to include addresses")
        ] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
