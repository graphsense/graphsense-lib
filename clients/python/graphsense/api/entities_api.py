...
class EntitiesApi:
    ...
    def get_entity(
        self,
        currency: Annotated[
            StrictStr, Field(description="The cryptocurrency code (e.g., btc)")
        ],
        entity: Annotated[StrictInt, Field(description="The entity ID")],
        exclude_best_address_tag: Annotated[
            Optional[StrictBool],
            Field(description="Whether to exclude best address tag"),
        ] = None,
        include_actors: Annotated[
            Optional[StrictBool],
            Field(description="Whether to include actor information"),
        ] = None,
    ...
    def list_address_tags_by_entity(
        ...
        page: Annotated[
            Optional[StrictStr],
            Field(description="Resumption token for retrieving the next page"),
        ] = None,
        pagesize: Annotated[
            Optional[Annotated[int, Field(strict=True, ge=1)]],
            Field(description="Number of items returned in a single page"),
        ] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
        ...
        """  # noqa: E501
        warnings.warn(
            "GET /{currency}/entities/{entity}/tags is deprecated.", DeprecationWarning
        )
    ...
    def list_entity_links(
        ...
        min_height: Annotated[
            Optional[StrictInt],
            Field(description="Return transactions starting from given height"),
        ] = None,
        max_height: Annotated[
            Optional[StrictInt],
            Field(description="Return transactions up to (including) given height"),
        ] = None,
        min_date: Annotated[
            Optional[StrictStr], Field(description="Min date of txs")
        ] = None,
        max_date: Annotated[
            Optional[StrictStr], Field(description="Max date of txs")
        ] = None,
        order: Annotated[
            Optional[StrictStr], Field(description="Sorting order")
        ] = None,
        token_currency: Annotated[
            Optional[StrictStr],
            Field(description="Return transactions of given token or base currency"),
        ] = None,
        page: Annotated[
            Optional[StrictStr],
            Field(description="Resumption token for retrieving the next page"),
        ...
        """  # noqa: E501
        warnings.warn(
            "GET /{currency}/entities/{entity}/links is deprecated.", DeprecationWarning
        )
    ...
    def list_entity_neighbors(
        ...
        entity: Annotated[StrictInt, Field(description="The entity ID")],
        direction: Annotated[
            StrictStr, Field(description="Incoming or outgoing neighbors")
        ],
        only_ids: Annotated[
            Optional[StrictStr],
            Field(description="Restrict result to given set of comma separated IDs"),
        ] = None,
        include_labels: Annotated[
            Optional[StrictBool], Field(description="Whether to include labels")
        ] = None,
        page: Annotated[
            Optional[StrictStr],
            Field(description="Resumption token for retrieving the next page"),
        ...
        relations_only: Annotated[
            Optional[StrictBool],
            Field(description="Return only relations without entity details"),
        ] = None,
        exclude_best_address_tag: Annotated[
            Optional[StrictBool],
            Field(description="Whether to exclude best address tag"),
        ...
        """  # noqa: E501
        warnings.warn(
            "GET /{currency}/entities/{entity}/neighbors is deprecated.",
            DeprecationWarning,
        )
    ...
    def list_entity_txs(
        ...
        entity: Annotated[StrictInt, Field(description="The entity ID")],
        direction: Annotated[
            Optional[StrictStr], Field(description="Incoming or outgoing transactions")
        ] = None,
        min_height: Annotated[
            Optional[StrictInt],
            Field(description="Return transactions starting from given height"),
        ...
        """  # noqa: E501
        warnings.warn(
            "GET /{currency}/entities/{entity}/txs is deprecated.", DeprecationWarning
        )
    ...
    def search_entity_neighbors(
        ...
        skip_num_addresses: Annotated[
            Optional[StrictInt],
            Field(description="Skip entities with more than N addresses"),
        ] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
