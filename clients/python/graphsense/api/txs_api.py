...
class TxsApi:
    ...
    def get_spending_txs(
        ...
        io_index: Annotated[
            Optional[StrictInt], Field(description="Input index to check")
        ] = None,
    ...
    def get_spent_in_txs(
        ...
        tx_hash: Annotated[StrictStr, Field(description="The transaction hash")],
        io_index: Annotated[
            Optional[StrictInt], Field(description="Output index to check")
        ] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def get_tx(
        ...
        tx_hash: Annotated[StrictStr, Field(description="The transaction hash")],
        token_tx_id: Annotated[
            Optional[StrictInt],
            Field(description="Token transaction ID for account-model currencies"),
        ] = None,
        include_io: Annotated[
            Optional[StrictBool],
            Field(description="Include transaction inputs/outputs"),
        ] = None,
        include_nonstandard_io: Annotated[
            Optional[StrictBool],
            Field(description="Include non-standard inputs/outputs"),
        ] = None,
        include_io_index: Annotated[
            Optional[StrictBool], Field(description="Include input/output indices")
        ] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def get_tx_conversions(
        self,
        currency: Annotated[
            StrictStr, Field(description="The cryptocurrency code (e.g., eth)")
        ],
        tx_hash: Annotated[StrictStr, Field(description="The transaction hash")],
        _request_timeout: Union[
            None,
    ...
    def list_token_txs(
        ...
        """  # noqa: E501
        warnings.warn(
            "GET /{currency}/token_txs/{tx_hash} is deprecated.", DeprecationWarning
        )
    ...
    def list_tx_flows(
        ...
        tx_hash: Annotated[StrictStr, Field(description="The transaction hash")],
        strip_zero_value_txs: Annotated[
            Optional[StrictBool], Field(description="Strip zero value transactions")
        ] = None,
        only_token_txs: Annotated[
            Optional[StrictBool], Field(description="Only return token transactions")
        ] = None,
        token_currency: Annotated[
            Optional[StrictStr], Field(description="Filter by token currency")
        ] = None,
        page: Annotated[
            Optional[StrictStr],
