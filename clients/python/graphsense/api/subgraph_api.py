...
class SubgraphApi:
    ...
    def subgraph_summary(
        ...
        :type currency: str
        :param subgraph_summary_request: (required)
        :type subgraph_summary_request: SubgraphSummaryRequest
    ...
    def _subgraph_summary_serialize(
        ...
        if subgraph_summary_request is not None:
            _body_params = subgraph_summary_request
