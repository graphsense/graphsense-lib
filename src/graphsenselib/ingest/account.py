...
class ETLEth(ETL):
    ...
    def transform(self, data):
        ...
        # todo, should also work to use a lookup to get the right
        #   BINARY_COL_CONVERSION_MAP
        txs = to_bytes(
            txs, BINARY_COL_CONVERSION_MAP_ACCOUNT["transaction"]
...
def export_parquet(
    ...
    dump_writer = DeltaDumpWriterFactory.create_writer(
