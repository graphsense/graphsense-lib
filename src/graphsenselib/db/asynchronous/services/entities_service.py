...
class EntitiesService:
    ...
    def _from_row(
        ...
        return Entity(
            ...
            no_incoming_txs=saturate_int32_count(row["no_incoming_txs"]),
            no_outgoing_txs=saturate_int32_count(row["no_outgoing_txs"]),
            ...
            in_degree=saturate_int32_count(row["in_degree"]),
            out_degree=saturate_int32_count(row["out_degree"]),
